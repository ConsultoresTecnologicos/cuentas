# Generated by Django 2.2 on 2019-04-13 22:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=18, default=Decimal('0.0'), default_currency='USD', max_digits=30)),
                ('account_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='amounts', to='accounts.AccountItems')),
            ],
            options={
                'verbose_name': 'amount',
